...
def _sync_append(results, sheet_id: str) -> str:
...
async def append_to_sheet(results, sheet_id: Optional[str] = None) -> str:
    ...
    return await asyncio.to_thread(_sync_append, results, sid)
